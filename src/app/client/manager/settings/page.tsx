...
export default function ManagerSettingsPage() {
  ...
  const [categoryEmployeeCounts, setCategoryEmployeeCounts] = useState<
  ...
  const [categoryRounding, setCategoryRounding] = useState<
    Record<string, number>
  >({});
  ...
  const [previewView, setPreviewView] = useState<"weekly" | "today_only">(
    "weekly",
  );
  ...
  const handleDeleteCategory = async (id: string, name: string) => {
    if (
      !confirm(
        `Delete category "${name}"? This will unassign all employees from it — employees themselves will not be affected.`,
      )
    )
      return;
    try {
   ...
   */
  const handleUpdateDashboardView = async (
    id: string,
    view: "weekly" | "today_only",
  ) => {
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  <m.div whileHover={{ scale: 1.02 }} className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Input
                        ...
                        className="focus:border-primary/50 border-neutral-700 bg-neutral-800/50 backdrop-blur-sm transition-all"
                      />
                ...
                <m.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    ...
                    disabled={saving}
                    className="bg-primary text-primary-foreground shadow-primary/30 hover:bg-primary/90 hover:shadow-primary/40 shadow-lg transition-all hover:shadow-xl"
                  >
            ...
            >
              ...
              <p className="mb-4 text-xs text-neutral-500 italic">
                * Categories are used to organise and filter staff on the
                payroll dashboard. Each employee can belong to one category.
              </p>
                      ...
                      <>
                        ...
                        <div className="flex min-w-0 flex-1 items-center gap-2">
                          ...
                          <span className="text-xs text-neutral-500">
                            {categoryEmployeeCounts[cat.id] ?? 0} employee
                            {(categoryEmployeeCounts[cat.id] ?? 0) !== 1
                              ? "s"
                              : ""}
                          </span>
                        </div>
                        ...
                        <div className="flex shrink-0 gap-2">
                          ...
                          <div className="relative">
                            <button
                              onClick={() =>
                                setSettingsOpenId(
                                  settingsOpenId === cat.id ? null : cat.id,
                                )
                              }
                            ...
                            {settingsOpenId === cat.id && (
                              <>
                                ...
                                />
                                <div className="absolute top-full right-0 z-20 mt-1.5 w-64 rounded-xl border border-neutral-700 bg-neutral-900 p-3 shadow-xl shadow-black/60">
                                  ...
                                  <div className="flex rounded-lg border border-neutral-700 bg-neutral-800 p-0.5">
                                    <button
                                      ...
                                      onClick={() => {
                                        if (cat.dashboard_view !== "weekly")
                                          void handleUpdateDashboardView(
                                            cat.id,
                                            "weekly",
                                          );
                                      }}
                                    ...
                                    <button
                                      disabled={updatingViewId === cat.id}
                                      onClick={() => {
                                        if (cat.dashboard_view !== "today_only")
                                          void handleUpdateDashboardView(
                                            cat.id,
                                            "today_only",
                                          );
                                    ...
                                    <div className="mt-3 border-t border-neutral-800 pt-3">
                                      ...
                                      <div className="grid grid-cols-5 gap-1">
                                        {[0, 5, 10, 15, 30].map((mins) => {
                                          const active =
                                            (categoryRounding[cat.id] ?? 0) ===
                                            mins;
                                          return (
                                            <button
                                              key={mins}
                                              onClick={() =>
                                                void handleUpdateRounding(
                                                  cat.id,
                                                  mins,
                                                )
                                              }
                                  ...
                                  <p className="mt-2 text-xs text-neutral-600">
                                    Controls what employees in this category see
                                    on their dashboard.
                                  </p>
                                </div>
                              </>
                          ...
                          <button
                            onClick={() =>
                              void handleDeleteCategory(cat.id, cat.name)
                            }
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="focus:border-primary/50 border-neutral-700 bg-neutral-800/50 backdrop-blur-sm"
                />
                <Button
              ...
              <p className="mt-2 text-xs text-neutral-600 italic">
                * Deleting a category unassigns all employees from it —
                employees themselves are not affected.
              </p>
                  ...
                  >
                    <div>
                      <p className="text-sm font-medium text-neutral-400">
                        Bulk assign employees to categories
                      </p>
                      <p className="text-xs text-neutral-600 italic">
                        * You can also assign a category individually via the
                    ...
                    <div className="mt-4">
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b border-neutral-800 text-left text-xs tracking-wide text-neutral-500 uppercase">
                              ...
                              .map((emp) => (
                                ...
                                >
                                  ...
                                  <td className="py-2 pr-4">
                                    <span
                                      className={`rounded px-1.5 py-0.5 text-xs font-medium ${emp.pay_type === "day_rate" ? "bg-neutral-800 text-green-400" : "bg-neutral-800 text-blue-400"}`}
                                    >
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-3 border-t border-neutral-800/50 pt-3">
                        ...
                        <button
                          ...
                          disabled={
                            selectedEmployeeIds.size === 0 || bulkApplying
                          }
              ...
              <div className="mt-6 border-t border-neutral-800 pt-5">
                ...
                >
                  <div>
                    <p className="text-sm font-medium text-neutral-400">
                      Preview employee views
                    </p>
                    <p className="text-xs text-neutral-600 italic">
                      See what each view looks like for employees before
                        ...
                        <div className="p-4">
                          ...
                          <div className="space-y-1.5">
                            {[
                              ...
                              >
                                <span className="w-7 text-xs text-neutral-500">
                                  {day}
                                </span>
                          ...
                          <p className="mt-2 text-center text-xs text-neutral-600">
                            Weekly Schedule — 7-day grid with time pickers
                          </p>
                        </div>
                      ) : (
                        <div className="p-4">
                          ...
                          <p className="mt-3 text-center text-xs text-neutral-600">
                            Clock In/Out — today only, two big action buttons
                          </p>
                        </div>
                      )}
                    </div>
              ...
              {!loading && employees.length > 0 && (
                <div className="relative mb-4">
                  ...
                  <Input
                    ...
                    className="focus:border-primary/50 border-neutral-700 bg-neutral-800/50 pl-10 backdrop-blur-sm transition-all"
                  />
                </div>
              )}
                ...
                <div className="space-y-3">
                  {filteredEmployees.map((emp, index) => (
                    <m.div
                      ...
                      className="hover:border-primary/30 flex items-center justify-between rounded-xl border border-neutral-800 bg-neutral-900/50 p-4 backdrop-blur-sm transition-all hover:bg-neutral-900/80"
                    >
                      <div className="flex-1">
                        ...
                        <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-sm text-neutral-400">
                          ...
                          <span>
                            PH: $
                            {(emp.public_holiday_rate as number | undefined) ??
                              emp.weekday_rate * 2}
                            {emp.pay_type === "day_rate" ? "/day" : "/h"}
                          </span>
