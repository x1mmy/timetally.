    ...
    <LazyMotion features={loadDomAnimation}>
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-neutral-950 text-white">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="bg-primary/10 absolute top-20 left-1/4 h-96 w-96 animate-pulse rounded-full blur-3xl" />
          <div className="absolute right-1/4 bottom-20 h-96 w-96 animate-pulse rounded-full bg-purple-500/10 blur-3xl" />
        </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="bg-primary/20 rounded-2xl p-6">
                    <Lock className="text-primary/30 h-16 w-16" />
                  </div>
                </m.div>
              </div>
            </m.div>
