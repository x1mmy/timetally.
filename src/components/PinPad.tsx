...
export function PinPad({ length = 4, onComplete, onClear }: PinPadProps) {
  ...
  return (
    <div className="rounded-2xl p-6 ring-1 ring-blue-500/40 shadow-xl shadow-blue-500/50">
        ...
        <div className="grid grid-cols-3 gap-4 w-full max-w-xs">
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
            <Button
              ...
              className="h-16 text-2xl bg-neutral-800 border-neutral-700 hover:bg-blue-600/20 hover:border-blue-500 focus-visible:ring-blue-500/50"
            >
              {num}
            </Button>
          ))}
          ...
          <Button
            ...
            className="h-16 bg-neutral-800 border-neutral-700 hover:bg-blue-600/20 hover:border-blue-500 focus-visible:ring-blue-500/50"
          >
